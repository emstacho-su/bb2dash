...
| S2-carry-2 | grades | V-1 grading validation still stubbed: 18 placeholders without points (21 on 2026-09-16), IST.323's 13-point proposal column counts toward two parts, migration 059 held | `sprint-1-hub/briefs/63_GRADING_VALIDATION.md` | Stack's sittings + one data migration |
