...
-- Backfilled 2026-09-09 from live migration 20260902205603 (applied via Supabase MCP on 2026-09-02).
-- Classifies bb_files into buckets, links files to course entities, and stores extracted text.
