-- bb2dash :: 018_hybrid_similarity.sql
-- A relevance floor and a real similarity column for hybrid_search_file_text().
--
-- PROVENANCE: applied to prod out-of-band by a concurrent bb2dash session on 2026-09-09,
-- recorded there under the colliding name `012_hybrid_similarity`. Captured here under the
-- correct next number (018) so the repo reproduces prod; the state is identical either way.
--
