...
- `db/migrations/014..019_*.sql` — GUI v1 phase: planner columns, effort base, work items, course display, files_current, sync contract (renumbered from 012–017 after the retrieval-MCP merge; see `docs/planning/sprint-0-foundation/41_RECONCILIATION_gui_vs_retrieval-mcp.md`).
